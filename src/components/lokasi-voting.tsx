...
const LokasiVoting = () => {
    ...
    return (
      <div className='z-[1] flex items-center justify-center flex-col'>
        ...
        <div className='bg-red-1 lg:pt-5 lg:px-5 w-[60vw] rounded-lg overflow-clip'>
          <div>
            <iframe
          ...
          <div className='flex flex-row justify-center'>
            <div className='mx-5 my-4 px-3 py-2 bg-red-3 rounded-lg w-fit flex flex-row justify-center items-center gap-6'>
              {/* for carousel */}
                <Button onClick={cycleBackward} size="icon" variant="secondary" className='rounded-full'>
                  <ChevronLeft className="h-4 w-4 text-red-3" strokeWidth={3}/>
                </Button>
                <div className='font-body text-white antialiased text-center lg:w-[100px]'>
                  {keyLokasi[currentIdx]}
                </div>
                <Button onClick={cycleForward} size="icon" variant="secondary" className='rounded-full'>
