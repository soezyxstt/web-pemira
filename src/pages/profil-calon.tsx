import { header, body, bodyBold } from "@fonts";
...
const ProfilCalon = () => {
  return (
    <div className="justify-content w-full items-center">
      <div>
        <div /* Text K3M */
        ...
        <div className="flex w-full space-x-16 p-14">
          ...
          <div /* data calon */ className="w-full">
              ...
              <CardContent>
                ...
                <div className="flex flex-col space-y-1">
                  ...
                  >
                    ...
                    malesuada fames ac turpis ultricies tristique nulla aliquet
                    enim. Diam phasellus vestibulum lorem sed. Dolor morbi non
                    arcu risus quis varius quam quisque. Enim eu turpis egestas
            ...
            <div className="flex flex-row pt-1">
              <div className="box-border flex w-full items-center justify-center rounded-2xl border-2 border-black bg-brown-5">
                <div className={`${body.className} text-3xl text-brown-1`}>
                  Portofolio
                </div>
              </div>
              <div
                /*logo ig */ className="ml-2 flex items-center justify-center"
              >
      ...
      <div>
        ...
        <div className="flex w-full space-x-16 p-14">
          <div
            /* Photo Carousel */ className="border-box flex-shrink-0 flex-grow-0"
          >
            <Carousel className="relative w-full max-w-xs">
              <CarouselContent>
                <CarouselItem>
